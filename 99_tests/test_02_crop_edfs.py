...
class TestCropEDFs:
    ...
    def test_setup_directories(self, temp_directory):
        ...
        with patch('crop_edfs.Path') as mock_path:
            # Mock Path objects
    ...
    @patch('crop_edfs.crop_edf_to_24_hours')
    ...
    @patch('crop_edfs.pyedflib.highlevel.write_edf')
    @patch('crop_edfs.pyedflib.highlevel.read_edf')
    ...
    @patch('crop_edfs.subprocess.check_output')
    @patch('crop_edfs.os.chdir')
    ...
    @patch('crop_edfs.setup_environment')
    @patch('crop_edfs.setup_directories')
    @patch('crop_edfs.discover_edf_files')
    @patch('crop_edfs.process_all_files')
